...
async function runLiveTest() {
	...
	const linkIdToTest = 'HIER_UW_LINK_ID_VOOR_V11'; // Vervang door de actuele link ID van 'v11'
	const destinationAddressToTest = 'Maastricht, Nederland'; // Vervang door het adres dat u wilt testen
	// --- EINDE CONFIGURATIE ---

	if (linkIdToTest.startsWith('HIER_UW')) {
		console.error('FOUT: Pas de linkIdToTest aan in het script voordat u het uitvoert.');
		return;
	}
